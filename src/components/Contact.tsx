...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      form.current,
      'WdF5QmuUMdCVFolW2'       // Replace with your EmailJS user/public key
      )
      .then(
        (result) => {
    ...
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto mb-6"></div>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Ready to transform your data into intelligent solutions? Let's discuss your next AI/ML
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 rounded-2xl text-white shadow-xl">
              <h3 className="text-2xl font-bold mb-4">Available for Projects</h3>
              <p className="text-blue-100 mb-6 leading-relaxed">
                I'm currently available for freelance data science projects, AI/ML consulting, and
                long-term collaborations. Let's build something incredible together!
              </p>
              <div className="space-y-3">
                <div className="flex items-center text-blue-100">
                  <Calendar className="w-5 h-5 mr-3" />
